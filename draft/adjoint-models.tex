...
\begin{definition}
  ...
  is a full subcategory of each $\cat{L}_{i}$ for $0 < i \leq n$.  Then a \textbf{structural
    adjoint model}, $\overleftarrow{\cat{L}_n : F_n \dashv G_n : \cat{L}_{n-1}}$, is a composition of monoidal adjunctions:
...
\begin{lemma}[Comonads in a Structural Adjoint Model]
  ...
  Suppose $\overleftarrow{\cat{L}_n : F_n \dashv G_n : \cat{L}_{n-1}}$ is a structural adjoint model.  Then
