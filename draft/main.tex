...
\begin{definition}
  \label{def:weakening}
  A \textbf{linear category with weakening}, $(\cat{L},w,\w{})$, is
  specified by
  \begin{itemize}
  ...
  \item a monoidal natural transformation $\w{}$ on $\cat{L}$ with
    components $\w{A}:wA\mto I$ s.t. the following diagrams commute:
  \end{itemize}
  \begin{mathpar}
    \bfig
    \square/->`->`->`->/<1000,500>[
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item $\c{A}:cwA\mto cwA\otimes cwA$ is defined as below. The left part
      ...
      $\cL{}^c$ and of $\cR{}^c$, and the right part commutes because
      $\cat{L}$ is monoidal.
      \begin{mathpar}
        \bfig
        \square/->`->``->/<1050,600>[
  ...
  \begin{itemize}
    \item[1.] Each $(cwA,\w{A},\c{A})$ is a comonoid, i.e.
      Diagrams~\ref{fig:commute-comonoid-1} and~\ref{fig:commute-comonoid-2}
      commute.
      ...
      \begin{mathpar}
        ...
        \efig
      \end{mathpar}
      \caption{Commutative comonoid 1}
      \label{fig:commute-comonoid-1}
      \end{figure}
...
\iffalse
      ...
      $(\cat{L},c,\cL{}^c,\cR{}^c)$ is a linear category with
...
\fi
      ...
      In the diagram chasing above, (1) commutes trivially and we would not
      expand $\c{}$ for simplicity. (2) and (4) commute because
      $(\cat{L},c,\cL{}^c,\cR{}^c)$ is a linear category with contraction.
      ...
      \efig
      \end{mathpar}
      \caption{Commutative Comonoid 2}
      \label{fig:commute-comonoid-2}
      \end{figure}
      %TODO: Second diagram above


    \item $\w{}$ and $\c{}$ are coalgebra morphisms, i.e.
      Diagrams~\ref{fig:coalgebra-morph-1} and~\ref{fig:coalgebra-morph-2}
      commute.
      \begin{figure}[!h]
      \begin{mathpar}
      \bfig
	...
	\square/->`->``/<1050,600>[
      ...
      \bfig
        \square/->`->``/<800,500>[
          ...
          \rho_{cwA}^{-1}`
          c\delta_A^w``]
        \morphism(800,500)<1200,0>[
          cwA\otimes I`
          (cwA\otimes I)\otimes cwA;
          \cL{wA,I}^c]
        \square(2000,200)/->``->`/<1300,300>[
          (cwA\otimes I)\otimes cwA`
          cwA\otimes cwA``
          c^2wA\otimes c^2wA;
          \rho_{cwA}\otimes id_{cwA}``
          \delta_{wA}^c\delta_{wA}^c`]
        \morphism(3300,200)|r|<0,-300>[
          c^2wA\otimes c^2wA`
          c^2w^2A\otimes c^2w^2A;
          c^2\delta_A^w\otimes c^2\delta_A^w]
        \morphism(3300,-100)|r|<0,-300>[
          c^2w^2A\otimes c^2w^2A`
          cwcwA\otimes cwcwA;
          cdist_{wA}\otimes cdist_{wA}]
        \morphism(3300,-400)|r|<0,-300>[
          cwcwA\otimes cwcwA`
          c(wcwA\otimes wcwA);
          \q{wcwA,wcwA}^c]
        \square(2000,-1000)/``->`->/<1300,300>[
          `
          c(wcwA\otimes wcwA)`
        ...
        \morphism(2000,-250)|m|<1300,750>[
          w(cwA\otimes cwA)`
          cwA\otimes cwA;
          \varepsilon_{cwA\otimes cwA}^w]
        \morphism(3300,-1000)|m|<-1300,750>[
          cw(cwA\otimes cwA)`
          w(cwA\otimes cwA);
      ...
      Part (c) commutes by the following diagram. (1) and (2) are
      the comonad law. (3) commutes by the condition of $dist_{wA}$.
      (4) and (6) commute by the naturality of $\varepsilon^c$. (5) and
      (7) commute because $w$ and $c$ are monoidal comonads.
      \begin{mathpar}
      \bfig
        \qtriangle|amm|/->`<-`=/<1300,400>[
          cwA\otimes cwA`
          cw^2A\otimes cw^2A`
          cw^2A\otimes cw^2A;
          c\delta_A^w\otimes c\delta_A^w`
          c\varepsilon_{wA}^w\otimes c\varepsilon_{wA}^w`]
        \ptriangle(1300,0)|amm|/->``->/<1300,400>[
          cw^2A\otimes cw^2A`
          c^2w^2A\otimes c^2w^2A`
          cw^2A\otimes cw^2A;
          \delta_{w^2A}^c\otimes\delta_{w^2A}^c``
          \varepsilon_{cw^2A}^c\otimes\varepsilon_{cw^2A}^c]
        \morphism(1300,0)|m|<0,-400>[
          cw^2A\otimes cw^2A`
          wcwA\otimes wcwA;
          dist_{wA}\otimes dist_{wA}]
        \morphism(0,400)|m|/<-/<1300,-800>[
          cwA\otimes cwA`
          wcwA\otimes wcwA;
          \varepsilon_{cwA}^w\otimes\varepsilon_{cwA}^w]
        \square(0,-800)|alab|/`<-``<-/<1300,1200>[
          cwA\otimes cwA``
          w(cwA\otimes cwA)`
          cw(cwA\otimes cwA);
          `
          \varepsilon_{cwA\otimes cwA}^w``
          \varepsilon_{w(cwA\otimes cwA)}^c]
        \Atriangle(0,-800)|mmm|/->`<-`/<1300,400>[
          wcwA\otimes wcwA`
          w(cwA\otimes cwA)`
          c(wcwA\otimes wcwA);
          \q{cwA,cwA}^w`
          \varepsilon_{wcwA\otimes wcwA}^c`]
        \square(1300,-800)|mmrb|/<-``->`<-/<1300,400>[
          wcwA\otimes wcwA`
          cwcwA\otimes cwcwA`
          cw(cwA\otimes cwA)`
          c(wcwA\otimes wcwA);
          ...
          \q{wcwA,wcwA}^c`
          c\q{cwA,cwA}^w]
        \morphism(2600,400)|r|<0,-800>[
          c^2w^2A\otimes c^2w^2A`
          cwcwA\otimes cwcwA;
          cdist_{wA}\otimes cdist_{wA}]
        \ptriangle(1000,150)/``/<100,100>[(1)``;``]
        \ptriangle(1600,150)/``/<100,100>[(2)``;``]
        \ptriangle(1000,-200)/``/<100,100>[(3)``;``]
        \ptriangle(1950,-200)/``/<100,100>[(4)``;``]
        \ptriangle(500,-400)/``/<100,100>[(5)``;``]
        \ptriangle(1300,-700)/``/<100,100>[(6)``;``]
        \ptriangle(2200,-650)/``/<100,100>[(7)``;``]
      \efig
      \end{mathpar}

    \item Any coalgebra morphism $f:(!A,\delta_A)\mto (!B,\delta_B)$
      between free coalgebras preserve the comonoid structure given
      by $\w{}$ and $\c{}$, i.e. the following two diagrams commute.
      \begin{mathpar}
      \bfig
        \Vtriangle/->`->`->/<600,500>[
          cwA`
	...
	\c{B}]
      ...
      The triangle on the left commutes by the diagram chasing below, which
      commutes by the definition of $\w{}^w$.
      \begin{mathpar}
      \bfig
        \btriangle/->``->/<800,800>[
        ...
        \Vtriangle(0,400)|amm|/->`->`->/<800,400>[
          ...
          c\w{A}^w`
          c\w{B}^w]
        \morphism(800,400)|m|<0,-400>[cI`I;\varepsilon_I^c]
      \efig
      \end{mathpar}

      The square on the left commutes by the diagram chasing below, which
      commutes by the naturality of $\rho$ and $\cL{}^c$.
      \begin{mathpar}
      \bfig
        \square|almb|/->`->`->`->/<600,500>[
          cwA`
