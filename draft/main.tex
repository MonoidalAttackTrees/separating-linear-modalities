...
\begin{proof}
  ...
  \efig
  \]
  Diagram one commutes trivially commutes, diagram two commutes
  ...
  diagram four and five commute by the coherence diagrams of $\e{}$,
  diagram six clearly commutes, diagram seven commutes because
  $(e,\varepsilon,\delta)$ is a comonad, and diagram eight commutes by
  both the action diagrams of the Eilenberg Moore category and the
  fact that $(e,\varepsilon,\delta)$ is a comonad.
